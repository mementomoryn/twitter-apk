# Chitter
Automated script to download X (Twitter) APK, and modified it with [Piko](https://github.com/crimera/piko) or [Hachidori](https://github.com/Xposed-Modules-Repo/com.twifucker.hachidori).
